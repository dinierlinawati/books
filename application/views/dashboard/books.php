    ...
    <input class="form-control form-control-dark" type="text" placeholder="Search" aria-label="Search" name="key" style="border: 1px solid #cccccc; margin-top: 20px;">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <h4><?php echo "Total Buku : ".$totalBuku; ?></h4>   
      </div>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo anchor('book/edit/'.$book_item['idbuku'], 'Edit', 'Edit Buku'); ?> | <?php echo anchor('book/view/'.$book_item['idbuku'], 'View', 'View Buku'); ?> | <?php echo anchor('book/delete/'.$book_item['idbuku'], 'Delete', 'Hapus Buku'); ?></td>
            </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
